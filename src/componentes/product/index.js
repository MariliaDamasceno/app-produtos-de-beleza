  ...
  return (
    <>
      <div className='bg-white border border-gray-100 transition transform duration-700 hover:shadow-xl hover:scale-105 p-4 rounded-lg relative'>
        ...
        <img className='w-60 h-60 mx-auto transform transition duration-300 hover:scale-105' src={product.imagem} alt='imagem do produto' />
        <div className='flex flex-col items-center my-3 space-y-2'>
          ...
          <button onClick={() => navigate(`/product/${product._id}`)} className='text-xs uppercase bg-primary px-4 py-2 font-bold text-secondary rounded-lg transition duration-700 hover:scale-105'>Ver mais</button>
        </div>
      </div>
    </>
  )
