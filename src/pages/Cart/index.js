...
import { sendCart, addOrder } from '../../service/orderService';
...
const Cart = () => {
  ...
  return (
    <main className='home-banner w-full'>
              ...
              <div className=" flex flex-col space-y-5">
                {productsCart.map((product) => (
                  <div key={product._id} className="rounded-lg p-4 flex space-x-4">
                    <div className="flex">
                      <img className="w-20 object-contain" src={product.imagem} alt={product.nome} />
                    </div>
